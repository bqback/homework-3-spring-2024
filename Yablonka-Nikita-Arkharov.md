...
![Выбор страны (рус.)](img/choose_country_rus.png)
...
* При нажатии на ссылку Политику конфиденциальности с выбранным языком Русский сайта открывается [русскоязычная страница политики конфиденциальности VK Рекламы](https://help.mail.ru/legal/terms/adsvk/termsofservice)
...
![Invididual description](img/individual_desc.png)
...
![Legal entity description](img/legal_entity_desc.png)
...
![Mailing description](img/mailing_description_eng.png)
...
![Импорт кабинета myTarget (рекламодатель) (агентство.)](img/import_mytarget_adv_rus.png)
...
![Лого в хедере (англ.)](img/header_logo_eng.png)
...
![Меню выбора рекламного кабинета (англ.)](img/ad_account_eng.png)
