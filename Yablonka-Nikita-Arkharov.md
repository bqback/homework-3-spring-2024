...
* При введении названия в инпут "Название" и нажатии вне инпута в пределах модального окна не на кнопку "Закрыть" или "Отмена" введённое значение сохраняется
...
* При вставлении ссылки на сообщество ВКонтакте с более чем 3 услугами чекбокс пропадает
...
* После заполнения и нажатия кнопки "Создать каталог" модальная страница закрывается и происходит редирект на страницу каталога (динамичная ссылка, содержащая ID каталога) с открытой вкладкой "История загрузок"
